...
public static class MutationPerformanceTests
{
    ...
    private static BenchmarkResult MeasurePrepared(
        string name,
        int operationCount,
        Func<OrbGraph> prepare,
        Action<OrbGraph> mutation,
    ...
    private static void WarmUp(
        ...
        IReadOnlyList<OrbEntity> entities)
    {
        var graph =
            new OrbGraph();
    ...
    private static void AddRelationships(
        OrbGraph graph,
        IReadOnlyList<OrbRelationship> relationships)
    {
        for (var index = 0;
        ...
        int operations)
    {
        ...
        Console.WriteLine(
            "║                ORB ENGINE MUTATION PERFORMANCE             ║");
    ...
    private sealed class WorkloadGenerator
    {
        ...
        public OrbEntity[] CreateEntities(
            int count)
        {
            var entities =
                new OrbEntity[count];
        ...
        public OrbRelationship[] CreateRelationships(
            IReadOnlyList<OrbEntity> entities)
        {
            var relationships =
                new OrbRelationship[
        ...
        public OrbRelationship[] CreateChurnWorkload(
            int count)
        {
            var relationships =
                new OrbRelationship[count];
        ...
        public OrbRelationship[] CreateMixedRelationships(
            IReadOnlyList<OrbEntity> entities,
            Guid anchorId)
        {
            var relationships =
