...
public static class DeterministicReplayTests
{
        ...
        int auditInterval)
    {
        ...
        Console.WriteLine(
            "╔══════════════════════════════════════════════════════════════╗");
        Console.WriteLine(
            "║                SOROPHY ENGINE DETERMINISTIC REPLAY             ║");
        Console.WriteLine(
            "╠══════════════════════════════════════════════════════════════╣");
        Console.WriteLine(
            $"║ Seed:           {seed,-41} ║");
    ...
    private sealed class ReplayRun
    {
            ...
            StressOperation operation)
        {
            ...
            if (graphException is not null)
            {
                ...
                {
                    throw new InvalidOperationException(
                        $"[{_name}] SorophyGraph rejected a valid entity.",
                        graphException);
                }
            ...
            {
                throw new InvalidOperationException(
                    $"[{_name}] SorophyGraph accepted a duplicate entity.");
            }
            ...
            if (actual)
            {
                        ...
                        operation.PrimaryId))
                {
                    throw new InvalidOperationException(
                        ...
                        "remove an entity accepted by SorophyGraph.");
                }
            }
        }
            ...
            StressOperation operation)
        {
            ...
            if (graphException is not null)
            {
                ...
                {
                    throw new InvalidOperationException(
                        $"[{_name}] SorophyGraph rejected a valid relationship.",
                        graphException);
                }
            ...
            {
                throw new InvalidOperationException(
                    $"[{_name}] SorophyGraph accepted an invalid relationship.");
            }
            ...
            if (actual)
            {
                        ...
                        operation.PrimaryId))
                {
                    throw new InvalidOperationException(
                        ...
                        "a relationship accepted by SorophyGraph.");
                }
            }
        }
            ...
            StressOperation operation)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"[{_name}] SorophyGraph accepted duplicate entity ID " +
            ...
            StressOperation operation)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"[{_name}] SorophyGraph accepted duplicate " +
            ...
            StressOperation operation)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"[{_name}] SorophyGraph accepted intentionally invalid " +
                    "relationship.");
            }
            ...
            StressOperation operation)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"[{_name}] SorophyGraph rejected a valid self relationship.",
                    graphException);
            }
            ...
            int operationNumber)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"[{_name}] SorophyGraph.Validate() reported " +
