...
internal static class Program
{
    ...
    {
        Console.WriteLine();
        Console.WriteLine("Orb Engine Test Arsenal");
        Console.WriteLine();
        ...
        Console.WriteLine("  dotnet run --project Orb.Engine.StressTests -- all");
        Console.WriteLine("  dotnet run --project Orb.Engine.StressTests -- all --profile full");
        Console.WriteLine("  dotnet run --project Orb.Engine.StressTests -- replay --seed 12345 --operations 10000");
        Console.WriteLine("  dotnet run --project Orb.Engine.StressTests -- list");
        Console.WriteLine();
    }
}
