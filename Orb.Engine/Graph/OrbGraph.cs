...
public sealed class OrbGraph
{
     ...
     */
    private readonly Dictionary<Guid, OrbEntity> _entities =
        new();

    private readonly Dictionary<Guid, OrbRelationship> _relationships =
        new();
    ...
    private readonly ReadOnlyDictionary<Guid, OrbEntity>
        _readOnlyEntities;

    private readonly ReadOnlyDictionary<Guid, OrbRelationship>
        _readOnlyRelationships;

    public OrbGraph()
    {
        _readOnlyEntities =
            new ReadOnlyDictionary<Guid, OrbEntity>(
                _entities);

        _readOnlyRelationships =
            new ReadOnlyDictionary<Guid, OrbRelationship>(
                _relationships);
    }
    ...
    public IEnumerable<OrbRelationship>
