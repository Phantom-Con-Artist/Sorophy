...
/// <summary>
/// Identifies the kind of authored temporal transition represented by an <see cref="SorophyEntityFact"/>.
/// </summary>
public enum SorophyEntityFactKind
{
    /// <summary>
    /// Represents the temporal creation of an entity.
    /// </summary>
    Created = 1,
