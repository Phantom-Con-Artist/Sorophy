...
public static class HighDegreeTopologyTests
{
    ...
    private static OrbGraph BuildGraph(
    ...
    {
        public required OrbEntity Hub { get; init; }

        public required OrbEntity ParallelTarget { get; init; }

        public required List<OrbEntity> Entities { get; init; }

        public required List<OrbRelationship> Relationships { get; init; }

        public required List<OrbRelationship> OutgoingRelationships { get; init; }

        public required List<OrbRelationship> IncomingRelationships { get; init; }

        public required List<OrbRelationship> IncidentRelationships { get; init; }

        public required List<OrbRelationship> SelfRelationships { get; init; }

        public required List<OrbRelationship> ParallelRelationships { get; init; }
