# Contributing to Sorophy Engine

Thank you for contributing to **Sorophy Engine**, the structured data and graph engine at the core of The Saga.

Sorophy Engine is maintained with a strong emphasis on explicit invariants, predictable behavior, serialization fidelity, a controlled public API, and adversarial testing. Contributions should preserve those properties rather than merely adding functionality.

## 1. Scope

This repository contains the Sorophy Engine and its automated verification projects.
...
Sorophy Engine uses both conventional unit tests and adversarial stress tests.
...
Sorophy Engine uses internal graph indexes and adjacency storage intended to reduce repeated allocation.
